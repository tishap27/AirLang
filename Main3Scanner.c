...
/* External objects */
extern airlang_intg line; /* Source code line numbers - defined in scanner.c */
 ...
 * -------------------------------------------------------------
 */
airlang_void printScannerError(airlang_strg fmt, ...);
airlang_void displayScanner(BufferPointer ptrBuffer);
airlang_long getScannerFilesize(airlang_strg fname);
