...
airlang_intg main1Coder(airlang_intg argc, airlang_strg* argv) {
	...
	airlang_strg operation = "";
	airlang_strg inputFileName = "";
	airlang_strg key = STR_LANGNAME;
	airlang_strg outputFileName = "";
	if (argc > 4) {
		operation = argv[2];
		...
		airlang_intg size = getSizeOfFile(outputFileName);
		airlang_strg output;
		if (atoi(operation) == CYPHER)
